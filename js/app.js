...
function showSlides() {
  let i;
  let slides = document
    .getElementsByClassName("fristsec_img")[0]
...
const learnMoreButtons = document.querySelectorAll(".f_btn");
...
// ____________(Contact Us(email))_________________
...
//   const serviceID = "service_z6nuyex";
//   const templateID = "template_8gzucnh";
